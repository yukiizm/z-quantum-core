...
class TestCreatingUnitaryFromCircuit:
    ...
    def test_constructing_unitary_from_circuit_without_free_params_gives_the_same_result_as_cirq(
        self, circuit
    ):
    ...
    def test_constructing_unitary_from_circuit_commutes_with_parameter_substitution(
        self,
    ):
